...
<c:forEach items="${list1}" var="log">
    ...
    <nav id="nav">
      <ul>
        <li><a href="#" class="active"><span class="icon icon-home">Intro</span></a></li>
...
<div id="main">
  ...
  <div class="container small"> <a href="#" class="image featured"><img src="images/pic01.jpg" alt=""></a>
      <header>
