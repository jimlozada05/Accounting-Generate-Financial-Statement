...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<IncomeStatement> isList=IncomeStatementDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("isList",isList);%>
  	...
  	<table class="table">
  		...
  		<c:forEach items="${isList}" var="is">
  		<tbody>
  		<tr>
  			<td>${is.getJournal_id()}</td>
  			<td>${is.getNet_worth()}</td>
  			<td><a href="IncomeStatement.jsp?journal_id=${is.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
