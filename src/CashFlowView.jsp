...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<CashFlow> cfList=CashFlowDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("cfList",cfList);%>
  	...
  	<table class="table">
  		...
  		<tbody>
  		<tr>
  			<td>${cf.getJournal_id()}</td>
  			<td>${cf.getCash()}</td>
  			<td>${cf.getCash_flow()}</td>
  			<td><a href="CashFlow.jsp?journal_id=${cf.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
