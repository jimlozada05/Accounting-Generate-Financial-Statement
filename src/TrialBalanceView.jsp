...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<TrialBalance> tbList=TrialBalanceDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("tbList",tbList);%>
  	...
  	<table class="table">
  		...
  		<tbody>
  		<tr>
  			<td>${tb.getJournal_id()}</td>
  			<td>${tb.getTotal_debit()}</td>
  			<td>${tb.getTotal_credit() * -1}</td>
  			<td><a href="TrialBalance.jsp?journal_id=${tb.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
