...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%
  		...
  		InvestingActivity ia = InvestingActivityDAO.getOneRecordByJournal(Integer.parseInt(request.getParameter("journal_id")));
  		request.setAttribute("ia",ia);
  		
  		FinancingActivity fa = FinancingActivityDAO.getOneRecordByJournal(Integer.parseInt(request.getParameter("journal_id")));
  		request.setAttribute("fa",fa);
  		
  		CashFlow cf = CashFlowDAO.getOneRecordByJournal(Integer.parseInt(request.getParameter("journal_id")));
  	...
  	<table class="table table-bordered">
		...
		<c:forEach items="${list}" var="list">
  			<tr>
	  				<c:if test="${list.getAccount_title() == AccountTitle.CASH}">
		...
		<tr><td colspan="2">=</td></tr>	
			...
			<tr>
				...
				<td><%=ia.getInvesting_activity()%></td>
			</tr>
			
			<tr>
				<td>Net Cash Flow from Financing Activities: </td>
				<td><%=fa.getFinancing_activity()%></td>
			</tr>
