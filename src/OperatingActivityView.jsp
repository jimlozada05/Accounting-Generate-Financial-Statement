...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<OperatingActivity> oaList=OperatingActivityDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("oaList",oaList);%>
  	...
  	<table class="table">
  		...
  		<tbody>
  		<tr>
  			<td>${oa.getJournal_id()}</td>
  			<td>${oa.getOperating_activity()}</td>
  			<td><a href="OperatingActivity.jsp?journal_id=${oa.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
