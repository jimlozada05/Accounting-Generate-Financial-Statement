...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<InvestingActivity> iaList=InvestingActivityDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("iaList",iaList);%>
  	...
  	<table class="table">
  		...
  		<tbody>
  		<tr>
  			<td>${ia.getJournal_id()}</td>
  			<td>${ia.getInvesting_activity()}</td>
  			<td><a href="InvestingActivity.jsp?journal_id=${ia.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
