...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<FinancingActivity> faList=FinancingActivityDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("faList",faList);%>
  	...
  	<table class="table">
  		...
  		<tbody>
  		<tr>
  			<td>${fa.getJournal_id()}</td>
  			<td>${fa.getFinancing_activity()}</td>
  			<td><a href="FinancingActivity.jsp?journal_id=${fa.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
