...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<FinancialPosition> fpList=FinancialPositionDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("fpList",fpList);%>
  	...
  	<table class="table">
  		...
  		<tbody>
  		<tr>
  			<td>${fp.getJournal_id()}</td>
  			<td>${fp.getTotal_asset()}</td>
  			<td>${fp.getTotal_asset()}</td>
  			<td><a href="FinancialPosition.jsp?journal_id=${fp.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
