...
<div id="main">
  ...
  <section id="top" class="one">
  	...
  	<%List<OwnerEquity> oeList=OwnerEquityDAO.getAllRecordsInCreator(sessionLogin_id);
	request.setAttribute("oeList",oeList);%>
  	...
  	<table class="table">
  		...
  		<c:forEach items="${oeList}" var="oe">
  		<tbody>
  		<tr>
  			<td>${oe.getJournal_id()}</td>
  			<td>${oe.getEnd_capital()}</td>
  			<td><a href="OwnerEquity.jsp?journal_id=${oe.getJournal_id()}" style="text-decoration:none;">View</a></td>
  		</tr>
  		</tbody>
  		</c:forEach>
